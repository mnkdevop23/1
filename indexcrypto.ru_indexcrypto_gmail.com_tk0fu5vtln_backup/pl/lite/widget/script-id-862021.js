document.addEventListener("DOMContentLoaded", function() {
    var script = document.getElementById('8df14b1cd189bdcf9039e2a27fbadad49ef86435');
    ...
    iframe.className = '468';
	iframe.id = '82dd157bd61001f7183f6315eea9578e69de6ea6' + '_' + iframe.className;
	...
	var gcEmbedOnMessage = function(e) {
		...
		if (e.data.uniqName == '8df14b1cd189bdcf9039e2a27fbadad49ef86435') {
			if (e.data.height) {
